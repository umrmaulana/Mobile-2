...
public class Prak2_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prak22);
                ...
                try{
                    ...
                    if(json.getString("result").toString().equals("1")){
                        if(json.getJSONObject("data").getString("status").equals("1")){
                            Toast.makeText(Prak2_2.this,"Login Berhasil",Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(Prak2_2.this,Prak2_2_Home.class);
                            ...
                            pd.dismiss();
                            AlertDialog.Builder msg = new AlertDialog.Builder(Prak2_2.this);
